...
class GenericOwnedAccessibleObject(GenericAccessibleObject, abc.ABC):
    """Abstract class for something that can be accessed and is owned by a type info."""
    ...
    def __init__(self, owner: TypeInfo, exporter_module: ModuleType | None = None):
        ...
        """
        assert (
            exporter_module is None or owner.raw_type in vars(exporter_module).values()
        )
...
class GenericEnum(GenericOwnedAccessibleObject):
    """Models an enum."""
...
class GenericConstructor(GenericCallableAccessibleObject, GenericOwnedAccessibleObject):
    """A constructor."""
    ...
    def __init__(
        ...
        Args:
            ...
            exporter_module: The optional module where the accessible object is exported
        """
        GenericCallableAccessibleObject.__init__(
            self,
...
class GenericMethod(GenericCallableAccessibleObject, GenericOwnedAccessibleObject):
    """A method."""
...
class GenericFunction(GenericCallableAccessibleObject):
    ...
    def __init__(
        ...
        Args:
            ...
            exporter_module: The optional module where the accessible object is exported
        """
        super().__init__(function, inferred_signature, raised_exceptions)
...
class GenericField(GenericAbstractField, GenericOwnedAccessibleObject):
    ...
    def __init__(
        ...
        Args:
            ...
            exporter_module: The optional module where the accessible object is exported
        """
        GenericAbstractField.__init__(self, field, field_type)
        GenericOwnedAccessibleObject.__init__(self, owner, exporter_module)
...
class GenericStaticField(GenericAbstractField, GenericOwnedAccessibleObject):
